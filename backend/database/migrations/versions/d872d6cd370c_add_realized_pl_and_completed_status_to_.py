"""Add realized_pl and COMPLETED status to trades

Revision ID: d872d6cd370c
Revises: 152736a7917b
Create Date: 2025-10-22 09:34:12.329144
...
revision: str = 'd872d6cd370c'
down_revision: Union[str, Sequence[str], None] = '152736a7917b'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'COMPLETED', 'EXECUTED', 'FAILED', 'CANCELLED', name='tradestatus'), nullable=False),
